...
namespace LemonadeStandPart2
{
    public class Game
    {
        ...
        {
            while (playerOne.Store.DaysOpen != 4)
            {
                Console.WriteLine();
                Console.WriteLine();
                RunDayOne();
        ...
        {
            while (playerOne.Store.DaysOpen != 7)
            {
                Console.WriteLine();
                Console.WriteLine();
                RunDayOne();
        ...
        {
            while (playerOne.Store.DaysOpen != 14)
            {
                Console.WriteLine();
                Console.WriteLine();
                RunDayOne();
        ...
        {
            Console.WriteLine("Care to refill you stock? Enter 'yes' or 'no': ");
