...
namespace LemonadeStandPart2
{
    public class Store
    {
        ...
        public void StoreStart(Player player)
        {
            ...
            Console.WriteLine("Welcome to the store! You must buy the necessary items to make your lemonade. What would you like to do:'buy' ingredients, 'check' inventory, 'leave' store?");
