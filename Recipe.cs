...
namespace LemonadeStandPart2
{
    public class Recipe
    {
        ...
        public void RecipeStart(Player player)
        {
            ...
            Console.WriteLine("Lets craft up some Lemoande! Here's what a typical lemonade recipe calls for 1 lemon, 2 sugars, and 2 ice, in one cup. It's up to you to determine the number of each ingredient to put in an individual cup. You will then decide how many cups to sell that day. Remember, the weather and the price will affect how many customers buy your lemonade. First, make your recipe, then make sure to set your price.\n\n");
            ...
            switch (userInput)
            {
                ...
                case "set":
                    ...
                    {
                        Console.WriteLine("You have no created any lemonade yet!");
                        Console.ReadKey();
                        Console.Clear();
                        RecipeStart(player);
                    }
                ...
                case "leave":
                    ...
                    {
                        Console.WriteLine("Your forgot to enter a price for your lemonade!");
                        Console.ReadKey();
                        Console.Clear();
                        RecipeStart(player);
                    }
        ...
        {
            Console.WriteLine("\nHow much sugar would you like per cup?");
        ...
        public int PickIce()
        {
            Console.WriteLine("\nHow much ice would you like per cup?");
        ...
        public int PickCup()
        {
            Console.WriteLine("\nHow many cups of lemonade would you like to craft?");
